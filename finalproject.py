...
#create a state to prevent request forgery
...
def gconnect():
    ...
    #Verification of access token that it is used for intended user
    ...
    #verification of access token for the app
    ...
    if not user_id:
       user_id = createUser(login_seesion)
...
def deleteRestaurant(restaurant_id):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
       ...
       <script>
        function myFunction(){
            alert('You are not authorized to delete this restaurent.
            Please create your own restaurent in order to delete.');
        }
        </script>
        <body onload='myFunction()''>
       """
